...
<head>
  ...
  <style>
    :root {{ --panel: rgba(15, 23, 42, 0.92); --text: #e2e8f0; --muted: #94a3b8; --accent-soft: rgba(56, 189, 248, 0.14); --border: rgba(148, 163, 184, 0.22); }}
    body {{ margin: 0; font-family: Roboto, Arial, sans-serif; background: linear-gradient(180deg, #0b1220 0%, #111827 100%); color: var(--text); }}
